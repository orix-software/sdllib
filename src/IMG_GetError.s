...
unsupported_image_format_string:
    .byte "Unsupported image format"

unable_to_open_file_string:
    .byte "Couldn't open file"

not_initialized_string:
    .byte "SDL_image not initialized"  ;     IMG_Init() n'a pas été appelé avant d'utiliser IMG_Load.

out_of_memory_string:
    .byte "Out of memory"

allocation_failed_string:
     .byte "Failed to allocate memory for image"
